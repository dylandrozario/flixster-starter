...
Deployed Application (optional): [Flixster Deployed Site](https://flixster-starter-1-pj3e.onrender.com/)
...
**Walkthrough video:** [Flixster Walkthrough](https://www.loom.com/share/651a90e323984c6899430f25f19d8989)

### Reflection

* Did the topics discussed in your labs prepare you to complete the assignment? Be specific, which features in your weekly assignment did you feel unprepared to complete?

The labs covered React fundamentals like components, props, state, and useEffect which directly applied to building the movie grid and search functionality. The Weather Report labs especially helped with API fetching patterns and controlled inputs. I felt less prepared for CSS 3D animations and the modal exit animation pattern — those required understanding of CSS transform properties and a delayed unmount trick that wasn't covered in labs.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

I would add localStorage persistence so favorites and watched lists survive page reloads, and implement infinite scroll with an intersection observer instead of the Load More button. If I could redo one thing, I'd set `box-sizing: border-box` globally from the start — that one missing property caused hours of debugging on the card flip animation where the front and back faces were different sizes.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

The Netflix-style dark theme and card flip animation came together well and made the app feel polished. The AI recommendation feature was exciting to implement but OpenRouter's rate limiting was frustrating during development — switching to a useEffect with a cancelled flag solved the double-fire issue from React StrictMode. The CSS 3D flip bug where padding made faces different sizes didn't go as planned and took significant debugging time.

### Open-source libraries used

- [Axios](https://axios-http.com/) — HTTP client for API calls
- [Serve](https://github.com/vercel/serve) — Static file server for Render deployment
